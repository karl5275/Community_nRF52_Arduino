...
#ifndef _VARIANT_HOLYIOT_18010_
#define _VARIANT_HOLYIOT_18010_
...
// LEDs
#define PIN_LED1             _PINNUM(1, 10)
#define PIN_LED2             _PINNUM(1, 13)
...
#define PIN_SERIAL1_RX      _PINNUM(0, 12)
#define PIN_SERIAL1_TX      _PINNUM(0, 25)
